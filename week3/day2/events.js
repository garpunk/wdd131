...
function taskTemplate(task) {
  ...
  <div>
    ...
    <span data-function="delete">yes</span>
  </div>
 </li>`;
}
...
function newTask() {
  ...
  tasks.push({ detail: todoInput, done: false });
  // render out the list
  renderTasks(tasks);
  // clear out input
...
// We need to attach listeners to the submit b
document.querySelector('#submitTask').addEventListener('click', newTask);

//We pass the function in but it won't run until we activate the "click" event
