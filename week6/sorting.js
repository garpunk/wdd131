...
// function compareFn(a, b) {
//   if (a.distance.toLowerCase() < b.distance.toLowerCase()) {
//     return -1;
//   } else if (a.distance.toLowerCase() > b.distance.toLowerCase()) {
//     return 1;
//   }
//   // a must be equal to b
//   return 0;
// }
// const hikeSort = simpleList.sort(compareFn);

// const simpleHikeSort = simpleList.sort(compareFn);
// console.log('post-sort', simpleList);
