...
function togglePaymentDetails(e) {
  ...
  // i need to add the option elements in the form
  if (theSelect.value == 'credit') creditCardContainer.classList.remove('hide');
  creditCardContainer.setAttribute('required', '');
}
document
